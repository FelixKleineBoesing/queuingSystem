...
class SchedulerGreedyTester(unittest.TestCase):
    ...
    def test_construction(self):
        scheduler = SchedulerGreedy(demands=self.agents_per_hour, lunch_time=1,
    ...
    def test_solve(self):
        ...
        self.assertEqual(np.sum(shifts, axis=1).tolist(), [12.0, 12.0, 14.0, 14.0, 19.0, 26.0, 24.0, 35.0, 39.0,
